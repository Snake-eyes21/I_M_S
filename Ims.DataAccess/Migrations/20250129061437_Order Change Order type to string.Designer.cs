...
namespace Ims.DataAccess.Migrations
{
    ...
    [Migration("20250129061437_Order Change Order type to string")]
    partial class OrderChangeOrdertypetostring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ims.Models.OrderDetail", b =>
                {
                    b.HasOne("Ims.Models.Order", "Orders")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ims.Models.Product", "Products")
                        .WithMany()
